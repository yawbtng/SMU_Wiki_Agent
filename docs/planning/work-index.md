...
Ralph should stop when every spec in `specs/` has `## Status: COMPLETE` and the latest verification pass is recorded in `docs/planning/work-index.md`, `docs/planning/history.md`, and `docs/planning/completion_log/`.
...
| 002 | `specs/002-wire-wiki-ui-pi-sdk.md` | TODO | Wire Build/Update Wiki controls and Pi SDK activity to webapp realtime runtime |
...
| 005 | `specs/005-wiki-ralph-orchestrator-ui.md` | TODO | Launch Pi/Ralph wiki agent in tmux; stream checklist/events into webapp Wiki tab |
