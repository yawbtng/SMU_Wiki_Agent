# Ralph Wiggum Master Prompt: Ultra Fast RAG
...
3. `docs/planning/work-index.md` - Queue and stop rule
4. `docs/planning/history.md` - One-line log after each spec completion
5. `docs/planning/implementation-plan.md` - Prioritized task breakdown (planning mode)
...
2. **Implement using Ralph loop** - Use the appropriate command for your platform:
   ...
   Read docs/ralph/master-prompt.md and the constitution first.
